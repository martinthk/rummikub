...
// Use --bun to resolve platform specific optional dependencies (e.g. @rollup/rollup-darwin-x64)
// Ref: https://github.com/oven-sh/bun/issues/11511#issuecomment-2409119039
bun run --bun dev
```
